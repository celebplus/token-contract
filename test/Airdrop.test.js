...
const Airdrop = artifacts.require('CelebPlusAirdrop');
...
contract('Airdrop', ([creator, addr1, addr2, addr3, addr4, addr5]) => {
  const airdropFund = new BigNumber('10000e18');  // 10000 CELEBPLUS tokens
  const withdrawalAmount = new BigNumber('100e18');  // 100 CELEBPLUS tokens
  ...
  describe('Airdrop::functions', () => {
    it('sets token to be airdropped', async () => {
      let newToken = await CelebPlusToken.new(NAME, SYMBOL, DECIMALS, INITIAL_SUPPLY);
